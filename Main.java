...
public class Main {
    public static void main(String[] args) {
        ...
        Guarderia guarderia = new Guarderia("Guardería Pequeños Gigantes", "458963");
        ...
        System.out.println("Información completa de la guardería:");
        guarderia.mostrarInformacion();

        System.out.println("\nEstudiantes mayores a 5 años:");
        List<Estudiante> mayoresA5 = guarderia.obtenerEstudiantesMayoresA5();
